<script>
  let { steps = [], ariaLabel = 'Studio workflow' } = $props();
</script>
...
<style>
  .studio-workflow { display: grid; grid-template-columns: repeat(var(--workflow-cols, 4), 1fr); gap: 8px; list-style: none; margin: 0; padding: 0; }
