          ...
          <div class="flex items-start gap-3 p-4">
            ...
            <div class="flex items-center gap-1.5 shrink-0">
              ...
              <button
                ...
                class="p-1.5 rounded-lg border border-white/8 text-slate-500 hover:text-rose-400 hover:border-rose-500/30 transition-all cursor-pointer opacity-0 group-hover:opacity-100"
