...
const FILE_META = {
  ...
  'optional/tokens.sizes-extended.css': { category: 'Sizes-extended tokens',    area: 'sizes',    kind: 'token' },
...
function main() {
  ...
  const schema = {
    ...
    bundles:     'Array of bundle tiers that ship the element (essential, optimal, optimal-components, optimal-utilities, full).',
