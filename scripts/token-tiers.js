...
const ADVANCED = new Set([
  ...
  '--sf-fluid-custom-1-min', '--sf-fluid-custom-1-max',
  '--sf-fluid-custom-2-min', '--sf-fluid-custom-2-max',
  '--sf-fluid-custom-3-min', '--sf-fluid-custom-3-max',
  '--sf-fluid-custom-1', '--sf-fluid-custom-2', '--sf-fluid-custom-3',
