...
export const variableGroups = [
  {
    ...
    tokens: [
      ...
      { name: "--sf-color-{primary,secondary,tertiary,action,neutral,base}-{50-950}", description: "Palette scale: 50 (lightest) → 950 (darkest), mixed with base/text. Requires tokens.palette.css." },
      { name: "--sf-color-{primary,secondary,tertiary,action,neutral,base}-a{5-95}", description: "Alpha scale: 5%–95% opacity of the brand color. Requires tokens.palette.css." },
