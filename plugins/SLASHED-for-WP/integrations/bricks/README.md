...
- **Variable Pickers** - Registers every `--sf-*` CSS custom property declared in the active bundle (~810 in `optimal` or `full`) with the Bricks variable pickers and code editor autocomplete, organized into category groups
